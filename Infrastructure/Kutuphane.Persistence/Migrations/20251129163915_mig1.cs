        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, defaultValue: "Türkçe"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CopyNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LoanedByUserId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Copies_BookId_CopyNumber",
                table: "Copies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Copies_Status",
                table: "Copies",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_Loans_CopyId_Status",
                table: "Loans",
                columns: new[] { "CopyId", "Status" });
